 ...
 */
export function SummaryField({ slug, chapterId, value, mutate, mutateList }: SummaryFieldProps) {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className="flex items-center justify-between">
        <Label htmlFor="chapter-summary" className="text-xs font-medium">
          Summary
        </Label>
